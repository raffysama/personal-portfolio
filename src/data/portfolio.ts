...
export const projects: Project[] = [
  {
    ...
    description: "Production website enhancements, UI improvements, performance work, and feature support for a Japan-based health rent service.",
    status: "Done",
    image: "/images/duskin.png",
    stack: ["HTML", "JavaScript", "CSS"],
    icons: ["devicon-html5-plain colored", "devicon-javascript-plain colored", "devicon-css3-plain colored"],
    link: "https://healthrent.duskin.jp/",
  },
  {
    title: "Mini CRM / Pipeline Dashboard",
    category: "Full-stack",
    description: "CRM dashboard with lead management, kanban pipeline, auth, realtime records, and Supabase-powered workflows.",
    status: "In Progress",
    image: "/images/mini_crm.png",
    stack: ["React", "Tailwind", "Supabase", "TypeScript"],
    icons: ["devicon-react-original colored", "devicon-tailwindcss-plain colored", "devicon-supabase-plain colored", "devicon-typescript-plain colored"],
    link: "https://mini-crm-pipeline-dashboard.vercel.app/",
  },
  {
    title: "EZ Tracking",
    category: "Tracking App",
    description: "Realtime tracking system with location updates, activity history, and a focused interface for operational monitoring.",
    status: "In Progress",
    image: "/images/eztracking.png",
    stack: ["React", "Tailwind", "Firebase"],
    icons: ["devicon-react-original colored", "devicon-tailwindcss-plain colored", "devicon-firebase-plain colored"],
    link: "https://ez-tracking-iota.vercel.app/",
  },
  {
    title: "TechVault",
    category: "E-commerce",
    description: "Tech product storefront with browsing, cart flows, authentication, and customer order history.",
    status: "In Progress",
    image: "/images/techvault.png",
    stack: ["React", "TypeScript", "Tailwind", "Supabase"],
    icons: ["devicon-react-original colored", "devicon-typescript-plain colored", "devicon-tailwindcss-plain colored", "devicon-supabase-plain colored"],
    link: "https://techvault-coral.vercel.app/",
  },
  {
    title: "WarehouseIQ",
    category: "Inventory System",
    description: "Inventory platform with auth, roles, stock movements, dashboard insights, and staff management.",
    status: "In Progress",
  ...
  },
  {
    ...
    description: "Study platform with notes, flashcards, planner tasks, reviewers, shared resources, notifications, and PWA support.",
    status: "In Progress",
    image: "/images/studymate.png",
    stack: ["Next.js", "React", "TypeScript", "Supabase"],
    icons: ["devicon-nextjs-original", "devicon-react-original colored", "devicon-typescript-plain colored", "devicon-supabase-plain colored"],
    link: "https://studymate-sepia.vercel.app/",
  },
  {
    title: "La Moderno",
    category: "E-commerce",
    description: "Modern ecommerce experience with product browsing, cart management, authentication, and order history.",
    status: "In Progress",
    image: "/images/lamoderno.png",
    stack: ["Next.js", "React", "TypeScript", "Tailwind"],
    icons: ["devicon-nextjs-original", "devicon-react-original colored", "devicon-typescript-plain colored", "devicon-tailwindcss-plain colored"],
...
export const journey: JourneyItem[] = [
  {
    ...
    description: "Maintained and improved production web experiences, shipped UI enhancements, fixed issues, and optimized user-facing features.",
  },
  {
    year: "2021 - 2022",
    role: "Web Developer Trainee",
    company: "Self Learning",
    description: "Built strong foundations in HTML, CSS, JavaScript, front-end workflows, and core programming concepts.",
  },
  {
    year: "2014",
